...
function tile($row) {
    ...
    <div onclick='."'".'miniCard('.'"developer","edit",'.$row->getAppID().');return false;'."'".' ondblclick='."'".'cardView('.'"view",'.$row->getAppID().');return false;'."'".'>
        <div class="row font-white">
            ...
            <div class="col-sm-12 my-1 p-0">
                ...
                <script>
                    makeChartB('."'myChart".$row->getAppID()."', 'bar', '".$row->getPositiveRatings()."', '".$row->getNegative_Ratings()."', 'Positive Ratings', 'Negative Ratings', false".');
                </script>
            </div>
